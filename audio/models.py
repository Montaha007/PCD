...
class Disorder(models.TextChoices):
    ...
    HIGH_ANXIETY = 'high_anxiety', 'High Anxiety / Racing Thoughts'
    INSOMNIA = 'insomnia', 'Chronic Insomnia / Trouble Staying Asleep'
    LOW_MOOD = 'low_mood', 'Depression / Low Energy'
    OVERWHELMED = 'overwhelmed', 'Overwhelmed Mind / Adrenal Fatigue'

    # Legacy states retained for existing data.
